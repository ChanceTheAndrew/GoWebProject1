...
func index(w http.ResponseWriter, r *http.Request) {
	...
	db, err := sql.Open("mysql", "root:root@tcp(127.0.0.1:8889)/golangWebProject")
	if err != nil {
		panic(err)
	}
	defer db.Close()
...
func show_post(w http.ResponseWriter, r *http.Request) {
	...
	defer db.Close()
	fmt.Println("connect to post page")
